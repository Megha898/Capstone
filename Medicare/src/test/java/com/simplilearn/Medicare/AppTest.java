...
//loads the webpage 
	driver.get("http://localhost:9001/medicare/home");
...
//address details 
Thread.sleep(3000);
driver.findElement(page.GetAddressLine1()).sendKeys("Indiranagar");
driver.findElement(page.GetAddressLine2()).sendKeys("Babu Building");
driver.findElement(page.GetAddressCity()).sendKeys("Bangalore");
driver.findElement(page.GetAddressPostalCode()).sendKeys("560008"); 
driver.findElement(page.GetAddressState()).sendKeys("Karnataka");
